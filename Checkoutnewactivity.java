...
import com.example.emedcare.R;
import com.example.emedcare.viewmodel.CheckoutViewModel;
...
import com.example.emedcare.databinding.ActivityCheckoutnewactivityBinding;

/**
 * Checkout implementation for the app
 */
public class Checkoutnewactivity extends AppCompatActivity {
    ...
    private ActivityCheckoutnewactivityBinding layoutBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Quantityone=findViewById(R.id.detailDescription);
        Intent intent = getIntent();
        String str = intent.getStringExtra("message");
        Quantityone.setText(str);
    }

    private void initializeUi() {

        // Use view binding to access the UI elements
        layoutBinding = ActivityCheckoutnewactivityBinding.inflate(getLayoutInflater());
