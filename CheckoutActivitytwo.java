...
import com.example.emedcare.databinding.ActivityCheckoutActivitytwoBinding;
...
public class CheckoutActivitytwo extends AppCompatActivity {
    ...
    private ActivityCheckoutActivitytwoBinding layoutBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Quantitytwo=findViewById(R.id.detailDescription2);
        Intent intent = getIntent();
        String str = intent.getStringExtra("message");
        Quantitytwo.setText(str);
    }

    private void initializeUi() {

        // Use view binding to access the UI elements
        layoutBinding = ActivityCheckoutActivitytwoBinding.inflate(getLayoutInflater());
