...
import com.example.emedcare.databinding.ActivityCheckout3Binding;
...
public class CheckoutActivity3 extends AppCompatActivity {
    ...
    private ActivityCheckout3Binding layoutBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Quantitythree=findViewById(R.id.detailDescription);
        Intent intent = getIntent();
        String str = intent.getStringExtra("message");
        Quantitythree.setText(str);
    }

    private void initializeUi() {

        // Use view binding to access the UI elements
        layoutBinding = ActivityCheckout3Binding.inflate(getLayoutInflater());
